...
TEST(MobilityOperationMessageTest, DISABLED_testDecodeMobilityOperationMsg)
{
...
TEST(MobilityOperationMessageTest, DISABLED_testEncodeMobilityOperationMsg)
{
...
TEST(MobilityOperationMessageTest, DISABLED_testEncodeMobilityOperationMsg_base_case)
{
    //Mobility_Operation::Mobility_Operation_Message worker;
    cpp_message::Mobility_Operation worker;
    cav_msgs::MobilityHeader header;
