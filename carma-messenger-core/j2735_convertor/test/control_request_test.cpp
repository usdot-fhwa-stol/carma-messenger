...
{
  j2735_v2x_msgs::msg::TrafficControlRequestV01 in_msg;
  in_msg.reqid.id = {0, 1, 2, 3, 4, 5, 6, 7};
  in_msg.reqseq = 77;
  in_msg.scale = 2;
  
  j2735_v2x_msgs::msg::TrafficControlBounds b1;
  b1.oldest = 500;
  ...
  j2735_v2x_msgs::msg::TrafficControlBounds b2;
  b2.oldest = 500;
  ...
  j2735_v2x_msgs::msg::TrafficControlBounds b3;
  b3.oldest = 500;
  ...
  j2735_v2x_msgs::msg::TrafficControlBounds b4;
  b4.oldest = 500;
  ...
  carma_v2x_msgs::msg::TrafficControlRequestV01 out_msg;
...
TEST(ControlRequest, convertControlBoundsToCAV)
{
  ...
  j2735_v2x_msgs::msg::TrafficControlBounds in_msg;
  in_msg.oldest = 500;
  ...
  carma_v2x_msgs::msg::TrafficControlBounds out_msg;  
...
TEST(ControlRequest, convertControlRequestToJ2735)
{
  ...
  // Unscaled scenario
  carma_v2x_msgs::msg::TrafficControlRequestV01 in_msg;
  in_msg.reqid.id = {0, 1, 2, 3, 4, 5, 6, 7};
  in_msg.reqseq = 77;
  ...
  j2735_v2x_msgs::msg::TrafficControlRequestV01 out_msg;
  j2735_convertor::geofence_request::convert(in_msg, out_msg);
  ...
  // +1 Scaling
  carma_v2x_msgs::msg::TrafficControlRequestV01 in_msg2;
  in_msg2.reqid.id = {0, 1, 2, 3, 4, 5, 6, 7};
  
  carma_v2x_msgs::msg::TrafficControlBounds b5;
  ...
  j2735_v2x_msgs::msg::TrafficControlRequestV01 out_msg2;
  ...
  // +2 Scaling
  carma_v2x_msgs::msg::TrafficControlRequestV01 in_msg3;
  in_msg3.reqid.id = {0, 1, 2, 3, 4, 5, 6, 7};
  
  carma_v2x_msgs::msg::TrafficControlBounds b6;
  ...
  j2735_v2x_msgs::msg::TrafficControlRequestV01 out_msg3;
  ...
  // +3 Scaling
  carma_v2x_msgs::msg::TrafficControlRequestV01 in_msg4;
  in_msg4.reqid.id = {0, 1, 2, 3, 4, 5, 6, 7};
  
  carma_v2x_msgs::msg::TrafficControlBounds b7;
  ...
  j2735_v2x_msgs::msg::TrafficControlRequestV01 out_msg4;
  ...
  // -1 Scaling
  carma_v2x_msgs::msg::TrafficControlRequestV01 in_msg5;
  in_msg5.reqid.id = {0, 1, 2, 3, 4, 5, 6, 7};
  
  carma_v2x_msgs::msg::TrafficControlBounds b8;
  ...
  j2735_v2x_msgs::msg::TrafficControlRequestV01 out_msg5;
  ...
  // -2 Scaling
  carma_v2x_msgs::msg::TrafficControlRequestV01 in_msg6;
  in_msg6.reqid.id = {0, 1, 2, 3, 4, 5, 6, 7};
  
  carma_v2x_msgs::msg::TrafficControlBounds b10;
  ...
  j2735_v2x_msgs::msg::TrafficControlRequestV01 out_msg6;
  ...
  // -3 Scaling
  carma_v2x_msgs::msg::TrafficControlRequestV01 in_msg7;
  in_msg7.reqid.id = {0, 1, 2, 3, 4, 5, 6, 7};
  
  carma_v2x_msgs::msg::TrafficControlBounds b11;
  ...
  j2735_v2x_msgs::msg::TrafficControlRequestV01 out_msg7;
...
TEST(ControlRequest, convertControlBoundsToJ2735)
{
  ...
  j2735_v2x_msgs::msg::TrafficControlBounds out_msg;  
  j2735_convertor::geofence_request::convert(in_msg, out_msg, scale);
