...
void BSMConvertor::convert(const j2735_msgs::VehicleSize& in_msg, cav_msgs::VehicleSize& out_msg)
{
  ...
  out_msg.vehicle_width = ValueConvertor::valueJ2735ToCav<float_t>(
      in_msg.vehicle_width, units::CM_PER_M, out_msg.presence_vector, cav_msgs::VehicleSize::VEHICLE_WIDTH_AVAILABLE,
      j2735_msgs::VehicleSize::VEHICLE_WIDTH_UNAVAILABLE);

  // Convert Vehicle length
  out_msg.vehicle_length = ValueConvertor::valueJ2735ToCav<float_t>(
      in_msg.vehicle_length, units::CM_PER_M, out_msg.presence_vector, cav_msgs::VehicleSize::VEHICLE_LENGTH_AVAILABLE,
      j2735_msgs::VehicleSize::VEHICLE_LENGTH_UNAVAILABLE);
}
...
void BSMConvertor::convert(const j2735_msgs::AccelerationSet4Way& in_msg, cav_msgs::AccelerationSet4Way& out_msg)
{
  ...
  out_msg.longitudinal = ValueConvertor::valueJ2735ToCav<float_t>(
      ...
      cav_msgs::AccelerationSet4Way::ACCELERATION_AVAILABLE, j2735_msgs::AccelerationSet4Way::ACCELERATION_UNAVAILABLE);

  out_msg.lateral = ValueConvertor::valueJ2735ToCav<float_t>(in_msg.lateral, units::CM_PER_M, out_msg.presence_vector,
                                                             cav_msgs::AccelerationSet4Way::ACCELERATION_AVAILABLE,
                                                             j2735_msgs::AccelerationSet4Way::ACCELERATION_UNAVAILABLE);
  ...
  out_msg.vert = ValueConvertor::valueJ2735ToCav<float_t>(
      ...
      cav_msgs::AccelerationSet4Way::ACCELERATION_VERTICAL_AVAILABLE,
      j2735_msgs::AccelerationSet4Way::ACCELERATION_VERTICAL_UNAVAILABLE);

  // Convert Yaw Rate
  out_msg.yaw_rate = ValueConvertor::valueJ2735ToCav<float_t>(
      in_msg.yaw_rate, units::CENTI_DEG_PER_DEG, out_msg.presence_vector,
      cav_msgs::AccelerationSet4Way::YAWRATE_AVAILABLE, j2735_msgs::AccelerationSet4Way::YAWRATE_UNAVAILABLE);
}
...
void BSMConvertor::convert(const j2735_msgs::PositionalAccuracy& in_msg, cav_msgs::PositionalAccuracy& out_msg)
{
  ...
  out_msg.orientation = ValueConvertor::valueJ2735ToCav<double_t>(
      ...
      cav_msgs::PositionalAccuracy::ACCURACY_ORIENTATION_AVAILABLE,
      j2735_msgs::PositionalAccuracy::ACCURACY_ORIENTATION_UNAVAILABLE);
}
...
void BSMConvertor::convert(const j2735_msgs::BSMCoreData& in_msg, cav_msgs::BSMCoreData& out_msg)
{
  ...
  out_msg.sec_mark = ValueConvertor::valueJ2735ToCav<uint16_t>(
      in_msg.sec_mark, units::UNCHANGED, out_msg.presence_vector, cav_msgs::BSMCoreData::SEC_MARK_AVAILABLE,
      j2735_msgs::BSMCoreData::SEC_MARK_UNAVAILABLE);
  ...
  out_msg.latitude = ValueConvertor::valueJ2735ToCav<double_t>(
      ...
      cav_msgs::BSMCoreData::LATITUDE_AVAILABLE, j2735_msgs::BSMCoreData::LATITUDE_UNAVAILABLE);
  ...
  out_msg.longitude = ValueConvertor::valueJ2735ToCav<double_t>(
      ...
      cav_msgs::BSMCoreData::LONGITUDE_AVAILABLE, j2735_msgs::BSMCoreData::LONGITUDE_UNAVAILABLE);

  out_msg.elev = ValueConvertor::valueJ2735ToCav<float_t>(in_msg.elev, units::DECA_M_PER_M, out_msg.presence_vector,
                                                          cav_msgs::BSMCoreData::ELEVATION_AVAILABLE,
                                                          j2735_msgs::BSMCoreData::ELEVATION_UNAVAILABLE);

  // Convert Speed
  out_msg.speed = ValueConvertor::valueJ2735ToCav<float_t>(
      in_msg.speed, units::FIFTIETH_M_PER_M, out_msg.presence_vector, cav_msgs::BSMCoreData::SPEED_AVAILABLE,
      j2735_msgs::BSMCoreData::SPEED_UNAVAILABLE);

  // Convert Heading
  out_msg.heading = ValueConvertor::valueJ2735ToCav<float_t>(
      in_msg.heading, units::EIGHTIETH_DEG_PER_DEG, out_msg.presence_vector, cav_msgs::BSMCoreData::HEADING_AVAILABLE,
      j2735_msgs::BSMCoreData::HEADING_UNAVAILABLE);
  ...
  out_msg.angle = ValueConvertor::valueJ2735ToCav<float_t>(
      ...
      cav_msgs::BSMCoreData::STEER_WHEEL_ANGLE_AVAILABLE, j2735_msgs::BSMCoreData::STEER_WHEEL_ANGLE_UNAVAILABLE);
...
void BSMConvertor::convert(const cav_msgs::VehicleSize& in_msg, j2735_msgs::VehicleSize& out_msg)
{
  ...
  out_msg.vehicle_width = ValueConvertor::valueCavToJ2735<uint16_t>(
      in_msg.vehicle_width, units::CM_PER_M, in_msg.presence_vector, cav_msgs::VehicleSize::VEHICLE_WIDTH_AVAILABLE,
      j2735_msgs::VehicleSize::VEHICLE_WIDTH_UNAVAILABLE);

  // Convert Vehicle length
  out_msg.vehicle_length = ValueConvertor::valueCavToJ2735<uint16_t>(
      in_msg.vehicle_length, units::CM_PER_M, in_msg.presence_vector, cav_msgs::VehicleSize::VEHICLE_LENGTH_AVAILABLE,
      j2735_msgs::VehicleSize::VEHICLE_LENGTH_UNAVAILABLE);
}
...
void BSMConvertor::convert(const cav_msgs::BSMCoreData& in_msg, j2735_msgs::BSMCoreData& out_msg)
{
  ...
  out_msg.sec_mark = ValueConvertor::valueCavToJ2735<uint16_t>(
      in_msg.sec_mark, units::UNCHANGED, in_msg.presence_vector, cav_msgs::BSMCoreData::SEC_MARK_AVAILABLE,
      j2735_msgs::BSMCoreData::SEC_MARK_UNAVAILABLE);
  ...
  out_msg.speed = ValueConvertor::valueCavToJ2735<uint16_t>(
      in_msg.speed, units::FIFTIETH_M_PER_M, in_msg.presence_vector, cav_msgs::BSMCoreData::SPEED_AVAILABLE,
      j2735_msgs::BSMCoreData::SPEED_UNAVAILABLE);

  // Convert Heading
  out_msg.heading = ValueConvertor::valueCavToJ2735<uint16_t>(
      in_msg.heading, units::EIGHTIETH_DEG_PER_DEG, in_msg.presence_vector, cav_msgs::BSMCoreData::HEADING_AVAILABLE,
      j2735_msgs::BSMCoreData::HEADING_UNAVAILABLE);
