...
{
void SPATConvertor::convertTimeChangeDetails(const j2735_msgs::TimeChangeDetails& in_msg,
...
void SPATConvertor::convertIntersectionState(const j2735_msgs::IntersectionState& in_msg,
