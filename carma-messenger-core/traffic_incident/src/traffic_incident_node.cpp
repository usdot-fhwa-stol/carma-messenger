...
traffic_worker_(std::bind(&TrafficIncidentNode::publishTrafficIncidentMobilityOperation, this, std_ph::_1)) 
{
  ...
  const rclcpp_lifecycle::State &)
{
  ...
  // Setup pub/sub
  pinpoint_driver_sub_= create_subscription<gps_msgs::msg::GPSFix>("gps_common_fix", 10, std::bind(&TrafficIncidentWorker::pinpointDriverCallback, &traffic_worker_, std_ph::_1));
  traffic_mobility_operation_pub_= create_publisher<carma_v2x_msgs::msg::MobilityOperation>("outgoing_mobility_operation", 10);

  //setup services
  start_broadcast_request_service_server = create_service<carma_msgs::srv::SetTrafficEvent>("start_broadcasting_traffic_event", std::bind(&TrafficIncidentNode::startTrafficBroadcastCallback, this, std_ph::_1, std_ph::_2, std_ph::_3));
  stop_broadcast_request_service_server = create_service<std_srvs::srv::Trigger>("stop_broadcasting_traffic_event", std::bind(&TrafficIncidentNode::stopTrafficBroadcastCallback, this, std_ph::_1, std_ph::_2, std_ph::_3));
...
void TrafficIncidentNode::publishTrafficIncidentMobilityOperation(const carma_v2x_msgs::msg::MobilityOperation& traffic_msg)
{
 ...
 * **/
bool TrafficIncidentNode::startTrafficBroadcastCallback(const std::shared_ptr<rmw_request_id_t>, const carma_msgs::srv::SetTrafficEvent::Request::SharedPtr req, carma_msgs::srv::SetTrafficEvent::Response::SharedPtr resp)
{
 ...
 * Msg: MobilityOperation
 * **/
bool TrafficIncidentNode::stopTrafficBroadcastCallback(const std::shared_ptr<rmw_request_id_t>, const std_srvs::srv::Trigger::Request::SharedPtr req, std_srvs::srv::Trigger::Response::SharedPtr resp){
    try{
...
if(traffic_worker_.getDownTrack() >0  && traffic_worker_.getUpTrack()>0 && traffic_worker_.getMinGap() > 0 && traffic_worker_.getAdvisorySpeed() > 0) 
  {
    ...
    carma_v2x_msgs::msg::MobilityOperation traffic_mobility_msg = traffic_worker_.mobilityMessageGenerator(traffic_worker_.getPinPoint());      
