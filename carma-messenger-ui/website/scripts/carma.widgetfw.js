...
CarmaJS.WidgetFramework = (function () {
        ...
        */
        var showWidgetOptions = function() {
           ...
           // divWidgetOptions.style.display = 'block';
            ...
            // createCheckboxElement(divWidgetOptionsList, 1, "test", 1, 'groupWidgets', false, false, 'CarmaJS.WidgetFramework.activateWidget');
            
          //  createBtnWithLabelElement(divWidgetOptionsList, 'btnId', "btnValue",  'btnName','labelTitle', 'CarmaJS.WidgetFramework.activateWidget');
        ...
        */
        var clearWidgetArea = function () {
            ...
            $('#divCarmaMessengerView').append(myDiv);
        };

        /*
            Based on selected widgets, this loads the widgets onto the Driver View.
        */
        var loadWidgets = function(widgetName){
            console.log("loadWidgets is called. Widget name is: " + widgetName);
                ...
                $.ajax({
                     ...
                     success: function()
                     {
                        ...
                        scriptLoader([jsFilePath],function()
                        {
                            ...
                            eval('CarmaJS.WidgetFramework.truckInspection' + '.loadCustomWidget($("#divWidgetArea"),widgetName);');
                        });
